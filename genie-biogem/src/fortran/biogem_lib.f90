...
MODULE biogem_lib
  ...
  real::par_bio_red_URDOMfrac                                           ! production fraction of Ultra RDOM
  NAMELIST /ini_biogem_nml/par_bio_red_URDOMfrac
  ...
  real::par_bio_red_rP_POM_URDOM                                        ! P:C fractionation during POM->RDOM production
  real::par_bio_red_rN_POM_URDOM                                        ! N:C fractionation during POM->RDOM production
  NAMELIST /ini_biogem_nml/par_bio_red_rP_POM_URDOM,par_bio_red_rN_POM_URDOM
  ...
  real::par_bio_remin_URDOMfrac                                         ! fraction of POM remin concverted to URDOM
  NAMELIST /ini_biogem_nml/par_bio_remin_URDOMfrac
  ...
  real::par_bio_remin_URDOMlifetime                                     ! URDOC lifetime (yrs)
  NAMELIST /ini_biogem_nml/par_bio_remin_URDOMlifetime
  ...
  LOGICAL::ctrl_bio_remin_URDOM_photolysis                              ! URDOM degradation by (surface) photolysis only?
  NAMELIST /ini_biogem_nml/ctrl_bio_remin_URDOM_photolysis 
  CHARACTER(len=63)::opt_bio_red_DOMfrac                                ! DOM production option
  NAMELIST /ini_biogem_nml/opt_bio_red_DOMfrac
  CHARACTER(len=63)::opt_bio_red_URDOMfrac                              ! URDOM production option
  NAMELIST /ini_biogem_nml/opt_bio_red_URDOMfrac
  ...
  INTEGER,PARAMETER::n_diag_production                    = 07 ! 
  ...
  INTEGER,PARAMETER::idiag_bio_URDOMfrac                 = 24    !
  ! diagnostics - OLD
  ...
  ! diagnostics - DOC Production
  INTEGER,PARAMETER::idiag_production_LDOMpp             = 01    !
  INTEGER,PARAMETER::idiag_production_RDOMpp             = 02    !
  INTEGER,PARAMETER::idiag_production_URDOMpp            = 03    !
  INTEGER,PARAMETER::idiag_production_PP                 = 04    !
  INTEGER,PARAMETER::idiag_production_LDOMrp             = 05    !
  INTEGER,PARAMETER::idiag_production_RDOMrp             = 06    !
  INTEGER,PARAMETER::idiag_production_URDOMrp            = 07    !
  ...
  CHARACTER(len=14),DIMENSION(n_diag_geochem_old),PARAMETER::string_diag_geochem_old = (/ &
       ...
       & 'H2StoPOMS_dH2S'/)
  ! diagnostics - DOC production
  CHARACTER(len=14),DIMENSION(n_diag_production),PARAMETER::string_diag_production = (/ &
       & 'LDOMpp        ', &
       & 'RDOMpp        ', &
       & 'URDOMpp       ', &
       & 'PP            ', &
...
!!$! ***********
  ...
  REAL,DIMENSION(n_diag_production,n_i,n_j,n_k)::diag_production ! geochemistry diagnostics -- DOC production
...
!!!  REAL,DIMENSION(n_ocn,n_i,n_j)::diag_weather                    ! weathering diagnostics
  ...
  REAL,DIMENSION(n_diag_production)::int_diag_production_sig     ! geochemistry diagnostics -- DOC production
  ...
  REAL,DIMENSION(n_diag_production,n_i,n_j,n_k)::int_diag_production_timeslice ! DOC production
