...
MODULE gem_cmn
  ...
  INTEGER,PARAMETER::io_URDOM_C                           = 110   ! 
  INTEGER,PARAMETER::io_URDOM_N                           = 111   !
  INTEGER,PARAMETER::io_URDOM_P                           = 112   !
  INTEGER,PARAMETER::io_URDOM_C_13C                       = 113   !
  INTEGER,PARAMETER::io_URDOM_C_14C                       = 114   !
...
!!!  INTEGER,PARAMETER::par_sed_type_indepsinking            = 21    !
  ...
  real,DIMENSION(n_sed,n_ocn)::conv_URDOM_POM
  real,DIMENSION(n_ocn,n_sed)::conv_POM_URDOM
  ...
  integer,DIMENSION(0:n_sed,0:n_ocn)::conv_URDOM_POM_i
  integer,DIMENSION(0:n_ocn,0:n_sed)::conv_POM_URDOM_i
  ! tracer conversion -- transformation ratios -- compaxt index format
